...
router.get("/players/:id", readPlayerGame);
router.put("/players/:id", updatePlayer);
router.post('/players', createPlayer);
router.delete('/players/:id', readGameId);
...
function readGameId(req, res, next) {
    db.many("SELECT * FROM PlayerGame WHERE gameid={req.params.gameid}")
        .then(data => {
            returnDataOr404(res, data);
        })
        .catch(err => {
